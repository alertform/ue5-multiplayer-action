	...
	const FGameplayEventData* TriggerEventData)
{
	...
	// Mobile cast, no actor rotation: the upper body turns toward the camera via the
	// AnimInstance spine twist (gated on our owned State.Casting), the legs keep following
