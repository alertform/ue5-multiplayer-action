...
#include <type_traits>
// UE5.5 IWYU cleanup: these legacy trait headers are no longer transitively included
// by CoreUObject.h (the traits still exist, some marked deprecated). Include explicitly.
